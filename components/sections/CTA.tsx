...
export function CTA() {
  return (
    <Container className="relative max-w-5xl py-10 ">
      <div className="relative py-10 px-15 bg-lime-500 z-50 overflow-hidden rounded">
        ...
        <div className="relative flex justify-between items-center z-50">
          <div className="flex flex-col gap-3">
            <h1 className="isolate text-5xl font-bold text-gray-950 font-Sansation z-50">
              Get In Touch
            </h1>
          ...
          <FaWhatsapp className="fill-gray-900 stroke-2" size={80} />
        </div>
      </div>
    </Container>
  );
