...
export function Faq() {
  return (
    <div className="relative overflow-hidden py-20">
      <Container className="relative max-w-5xl py-10 overflow-hidden flex flex-col justify-center items-center gap-5">
        <p className="text-sm font-medium tracking-wider font-Sansation text-lime-600">
          Some Questions
        </p>
        <div className="flex gap-5 w-full items-center justify-center pb-20">
          <div className="w-28 h-0.5 bg-gray-600" />
          <h1 className="text-4xl font-medium">Questions And Answers</h1>
          <div className="w-28 h-0.5 bg-gray-600" />
        </div>
        <div className="w-3xl flex flex-col gap-8 bg-gray-800/30 px-10 py-15 rounded-lg ">
          {faqs.map((faq, index) => (
            <Disclosure
              as="div"
            ...
            >
              <DisclosureButton className="group flex w-full items-center justify-between">
                <span className="text-xl font-medium text-white group-data-hover:text-white/80">
                  {faq.question}
                </span>
